...
- Create private GitHub repository `name of repo`
...
- Configure kubectl
```bash
aws eks --region us-east-1 update-kubeconfig --name edstem-k8s-runner
```
...
- github_app_id - https://github.com/settings/apps/<app>
- github_app_installation_id - get while downloading the app from url
- github_app_private_key - download in local from https://github.com/settings/apps/<app> -> private keys
```bash
